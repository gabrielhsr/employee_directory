<?php
	...
	if(empty($error_check)) {
		if (empty($_FILES["photo"])) {
			$query_withoutphoto = "INSERT INTO employees VALUES ('".$id."', '".$position."', '".$registration."', '".$name."', '".$employee_function."', '".$department."', '".$location."', '".$email."', '".$phone."', 'blank.png')";
			...
			if(empty($photo_check)) {
				...
				$query = "INSERT INTO employees VALUES ('".$id."', '".$position."', '".$registration."', '".$name."', '".$employee_function."', '".$department."', '".$location."', '".$email."', '".$phone."', '".$photo_name."')";
