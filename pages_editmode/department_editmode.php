...
<head>
	<meta charset="utf-8">
	<title>Department Edit Mode</title>
...
<body>
	...
	<?php foreach($rows as $row) { ?>
		<div class="employee_container">
			<a href="/resources/delete/delete_department.php?delete=<?php echo $row["id"] ?>&department=<?php echo $row["department"]; ?>" target="iframe_employees" onClick="javascript:return confirm('Do you want to delete the register of <?php echo $row["name"];?>?');">
